        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationExam = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelSubject", x => new { x.levelsId, x.subjectsId });
                    table.ForeignKey(
                        name: "FK_LevelSubject_Levels_levelsId",
                        column: x => x.levelsId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LevelSubject_Subjects_subjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelSubjects", x => new { x.levelId, x.subjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LevelSubject_subjectsId",
                table: "LevelSubject",
                column: "subjectsId");
